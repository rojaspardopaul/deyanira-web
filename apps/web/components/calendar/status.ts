...
export const STATUS: Record<AptStatus, {
  ...
  pending:     { label: 'Solicitada', bgLight: 'bg-amber-50',   bgFull: 'bg-amber-400',   text: 'text-amber-700',   border: 'border-l-amber-400',   dot: 'bg-amber-400'   },
  ...
  in_progress: { label: 'En curso',   bgLight: 'bg-teal-50',    bgFull: 'bg-teal-500',    text: 'text-teal-700',    border: 'border-l-teal-500',    dot: 'bg-teal-500'    },
  completed:   { label: 'Atendida',   bgLight: 'bg-emerald-50', bgFull: 'bg-emerald-500', text: 'text-emerald-700', border: 'border-l-emerald-500', dot: 'bg-emerald-500' },
