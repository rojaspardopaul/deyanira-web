// Adaptador de la pasarela Culqi. Reutiliza lib/payments/culqi.js (llamada HTTPS +
// idempotency key) sin reescribirla. Los errores con culqiCode propagan tal cual.

import type { CargoPagos, PasarelaPagos, ResultadoCargo } from '../domain/ports/PasarelaPagos';
